...
from app.telegram.keyboards.callback_data.menu import CDAbout, CDMenu
from app.telegram.keyboards.common import back_keyboard
from app.telegram.keyboards.menu import about_keyboard
...
async def greeting(
    ...
    return await helper.answer(
        ...
        reply_markup=about_keyboard(i18n=i18n),
    )


@router.callback_query(CDAbout.filter())
